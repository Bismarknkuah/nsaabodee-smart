...
export type MomoTargetType = "contribution" | "gift" | "wallet_deposit";
...
export const momoApi = {
  ...
  /** 'Members can have their own wallet where they can deposit money.' A self-service top-up of the caller's own MemberWallet. */
  walletDeposit: (phoneNumber: string, amount: string) =>
    request<MomoPaymentRequest>(`/payments/momo/wallet-deposit/`, {
      method: "POST",
