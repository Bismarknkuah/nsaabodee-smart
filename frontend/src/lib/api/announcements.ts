...
export const announcementsApi = {
  ...
  submit: (communityId: string, input: { title: string; content: string; image?: File; video?: File; video_url?: string; funeral_event_id?: string; homepage_feature_requested?: boolean }) => {
    ...
    if (input.funeral_event_id) form.set("funeral_event_id", input.funeral_event_id);
