...
export const giftsApi = {
  ...
  /** Active AND pending, distinctly — for the registration panel itself, so a pending request is visible rather than simply absent until approved. */
  listAllDonationAccountsIncludingPending: (funeralId: string) =>
    request<DonationAccountRegistration[]>(`/funerals/${funeralId}/donation-accounts/?include_pending=true`),
