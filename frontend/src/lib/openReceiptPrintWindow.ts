...
export function openReceiptPrintWindow(text: string, qrCodeBase64?: string, widthMm: 58 | 80 = 80) {
  ...
  win.document.write(`
    <html>
      <head>
        ...
        <style>
          ...
          * { box-sizing: border-box; }
          ...
          .qr-code { display: block; margin: 8px auto 0; width: 120px; height: 120px; }
          .qr-caption { text-align: center; font-size: 10px; margin-top: 2px; }
      ...
      <body>
        ...
        ${qrCodeBase64 ? `
        <img class="qr-code" src="data:image/png;base64,${qrCodeBase64}" alt="Scan to confirm your payment" />
        <p class="qr-caption">Scan to confirm your payment</p>
        ` : ""}
        <div class="toolbar">
