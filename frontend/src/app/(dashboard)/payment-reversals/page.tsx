        ...
        <section className="mt-8">
          ...
          {isLoading ? (
            ...
            <ul className="mt-3 space-y-3">
              {pending.map((r) => (
                <li key={r.id} className="rounded-lg border border-[var(--gold)] bg-[var(--gold-soft)] p-4">
        ...
        {decided.length > 0 && (
          <section className="mt-8">
            ...
            <ul className="mt-3 space-y-2">
              {decided.map((r) => (
                <li key={r.id} className="rounded-lg border border-[var(--border)] bg-white p-3 text-sm">
