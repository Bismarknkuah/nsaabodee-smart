      ...
      <main className="mx-auto max-w-md px-8 py-8">
        {!referenceId && (
          <form onSubmit={submit} className="space-y-4">
            ...
            <div className="flex justify-end gap-2 border-t border-[var(--border)] pt-4">
              ...
              <button type="submit" disabled={isPending} className="rounded-lg px-4 py-2 text-sm font-medium text-white disabled:opacity-60" style={{ backgroundColor: "var(--violet)" }}>
        ...
        {referenceId && pollStatus === "awaiting_otp" && !resolvedRequest && (
          <form onSubmit={submitOtpCode} className="space-y-3">
            ...
            <button type="submit" disabled={submitOtp.isPending || !otp.trim()}
              className="w-full rounded-lg px-4 py-2 text-sm font-medium text-white disabled:opacity-60" style={{ backgroundColor: "var(--violet)" }}>
        ...
        {resolvedRequest && (
          <div className="space-y-3 text-center">
            ...
            <button onClick={() => router.back()} className="rounded-lg px-4 py-2 text-sm font-medium text-white" style={{ backgroundColor: "var(--violet)" }}>Done</button>
          </div>
        )}
      </main>
    </div>
