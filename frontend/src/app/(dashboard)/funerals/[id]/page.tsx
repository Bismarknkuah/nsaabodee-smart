  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
        ...
        <div className="mt-1 flex items-end justify-between gap-4">
          ...
          {funeral.status === "active" && canCloseFuneral && (
            <button
              ...
              className="rounded-sm border border-[var(--border)] px-4 py-2 text-sm font-medium hover:border-[var(--ink)]"
            >
              Close collection
            </button>
          )}
      ...
      <main className="px-8 pb-16">
        ...
        <div className="mb-4 rounded-sm border border-[var(--border)] bg-white p-4">
