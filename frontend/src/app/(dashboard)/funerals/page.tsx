        ...
        {(["pending_approval", "active", "closed"] as const).map((t) => (
          <button
            ...
            className={`px-4 py-1.5 font-mono text-xs font-medium uppercase tracking-wide ${
              tab === t ? "bg-[var(--ink)] text-white" : "text-[var(--text-soft)] hover:bg-[var(--bg)]"
            }`}
          >
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex gap-2">
            ...
            <button
              ...
              className="rounded-lg border border-[var(--border)] px-3 py-1.5 text-xs font-medium hover:border-[var(--clay-red)] hover:text-[var(--clay-red)]"
            >
              Reject
            </button>
          </div>
