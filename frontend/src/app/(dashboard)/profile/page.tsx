...
import { formatRoleOf } from "@/lib/formatRole";
          ...
          <form onSubmit={saveProfile} className="mt-4 space-y-4">
            <div className="flex items-center gap-5">
              <button
                ...
                className="group relative h-20 w-20 shrink-0 overflow-hidden rounded-full border border-[var(--border)] bg-[var(--bg)]"
                title="Change photo"
              >
                {displayPhoto ? (
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-soft)]">{formatRoleOf(user)}</p>
        ...
        <section className="mt-6 rounded-lg border border-[var(--border)] bg-white p-6">
          ...
          <form onSubmit={savePassword} className="mt-4 space-y-4">
            ...
            <button
              ...
              className="rounded-lg border border-[var(--border)] px-4 py-2 text-sm font-medium hover:border-[var(--forest)] hover:text-[var(--forest)] disabled:opacity-60"
            >
