  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <header className="border-b-2 border-[var(--ink)] px-8 py-6">
        <p className="font-mono text-[11px] font-medium uppercase tracking-[0.2em] text-[var(--text-soft)]">Account</p>
      ...
      <main className="mx-auto max-w-2xl px-8 py-8">
          ...
          <form onSubmit={saveProfile} className="mt-4 space-y-4">
            <div className="flex items-center gap-5">
              <button
                ...
                className="group relative h-20 w-20 shrink-0 overflow-hidden rounded-full border border-[var(--border)] bg-[var(--surface)]"
                title="Change photo"
              >
                {displayPhoto ? (
                  ...
                  <span className="flex h-full w-full items-center justify-center font-display text-2xl text-[var(--text-soft)]">
              ...
              <div>
                ...
                <p className="text-xs text-[var(--text-soft)]">{formatRole(user.role)}</p>
                {user.community_name && <p className="text-xs text-[var(--text-soft)]">{user.community_name}</p>}
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-sm border border-[var(--border)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
              />
              <p className="mt-1 text-xs text-[var(--text-soft)]">Setting this lets you sign in with a one-time SMS code instead of your password.</p>
            </div>
        ...
        {/* ---------- Password card ---------- */}
        <section className="mt-6 rounded-sm border border-[var(--border)] bg-white p-6">
          ...
          <form onSubmit={savePassword} className="mt-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-sm border border-[var(--border)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
              />
              <p className="mt-1 text-xs text-[var(--text-soft)]">At least 8 characters.</p>
            </div>
            ...
            <button
              ...
              className="rounded-sm border border-[var(--border)] px-4 py-2 text-sm font-medium hover:border-[var(--forest)] hover:text-[var(--forest)] disabled:opacity-60"
            >
