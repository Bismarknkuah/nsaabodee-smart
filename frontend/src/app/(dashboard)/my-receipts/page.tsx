...
function MyWalletSection() {
  ...
  return (
    <div className="border-b border-[var(--rule)] px-8 py-6" style={{ backgroundColor: "var(--forest-soft, #eef5f0)" }}>
      ...
      {showForm && !referenceId && (
        ...
        >
          <input
            ...
            required
            className="min-w-[12rem] rounded-sm border border-[var(--rule)] bg-white px-3 py-1.5 text-sm"
          />
          <input
            ...
            placeholder="Amount"
            required
            className="w-32 rounded-sm border border-[var(--rule)] bg-white px-3 py-1.5 text-sm"
          />
          <button
            type="submit"
      ...
      {referenceId && pollStatus === "polling" && (
        <p className="mt-4 text-sm text-[var(--ink-soft)]">Check your phone and approve the Mobile Money prompt…</p>
      )}
      {referenceId && pollStatus === "timed_out" && (
        <p className="mt-4 text-sm text-[var(--ink-soft)]">Still waiting on confirmation — check back in a moment.</p>
      )}
      {outcome === "successful" && (
