...
function DeliveryBadge({ channel }: { channel: "physical" | "electronic" }) {
  return (
    <span
      className={`rounded-full px-2 py-0.5 text-xs font-medium ${
        channel === "physical" ? "bg-[var(--gold-soft)] text-[var(--gold)]" : "bg-[var(--bg)] text-[var(--text-soft)]"
      }`}
    >
    ...
    <div className="border-b border-[var(--border)] px-8 py-6" style={{ backgroundColor: "var(--forest-soft, #eef5f0)" }}>
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <button
          ...
          className="shrink-0 rounded-lg border-2 border-[var(--forest)] px-4 py-2 text-sm font-medium text-[var(--forest)] hover:bg-[var(--forest)] hover:text-white"
        >
      ...
      {showForm && !referenceId && (
        ...
        >
          <input
            ...
            required
            className="min-w-[12rem] rounded-lg border border-[var(--border)] bg-white px-3 py-1.5 text-sm"
          />
          <input
            ...
            placeholder="Amount"
            required
            className="w-32 rounded-lg border border-[var(--border)] bg-white px-3 py-1.5 text-sm"
          />
          <button
            type="submit"
            disabled={initiate.isPending}
            className="rounded-lg bg-[var(--forest)] px-3 py-1.5 text-sm font-medium text-white disabled:opacity-50"
          >
