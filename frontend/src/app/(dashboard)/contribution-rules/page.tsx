          ...
          >
            <div>
              ...
              <input
                ...
                className="mt-1 block w-28 rounded-sm border border-[var(--border)] px-2 py-1.5 text-sm outline-none focus:border-[var(--forest)]"
              />
            </div>
            <div>
          ...
          >
            <div>
              ...
              <input type="number" min="0.01" step="0.01" value={headAmount} onChange={(e) => setHeadAmount(e.target.value)}
                ...
                className="mt-1 w-full rounded-sm border border-[var(--border)] px-2 py-1.5 text-sm outline-none focus:border-[var(--forest)]" />
            </div>
            <div>
            ...
            {[
              ...
              <div key={f.label}>
                ...
                <input
                  ...
                  className="mt-1 block w-20 rounded-sm border border-[var(--border)] px-2 py-1.5 text-sm outline-none focus:border-[var(--forest)]"
                />
              </div>
            ))}
            <button
          ...
          <div className="mt-3 flex flex-wrap items-end gap-3">
            <div>
              ...
              <select
                ...
                className="mt-1 block w-56 rounded-sm border border-[var(--border)] px-2 py-1.5 text-sm outline-none focus:border-[var(--forest)]"
              >
