  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <header className="border-b border-[var(--border)] bg-[var(--card)] px-8 py-6">
        <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-[var(--text-soft)]">Community Administration</p>
      ...
      <main className="px-8 py-8">
        <div className="grid grid-cols-2 gap-px border border-[var(--border)] bg-[var(--rule)] sm:max-w-md">
          ...
          <div className="bg-white px-4 py-3">
            <p className="font-mono text-[10px] font-medium uppercase tracking-[0.12em] text-[var(--text-soft)]">Inactive for at least</p>
            <select
              value={days}
              ...
              <li key={m.member_id}>
                <Link href={`/members/${m.member_id}`} className="flex items-center gap-3 px-1 py-3 hover:bg-white">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="font-mono text-xs text-[var(--text-soft)]">{m.membership_number}</p>
                  </div>
