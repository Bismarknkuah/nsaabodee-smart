        ...
        <div className="flex flex-wrap items-end gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="mt-1 rounded-sm border border-[var(--border)] bg-white px-3 py-1.5 text-sm"
            >
            ...
            <li key={m.id}>
              <Link href={`/members/${m.id}`} className="flex items-center gap-4 py-3.5 hover:bg-white">
                ...
                {m.photo_url ? (
                  ...
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--surface)] font-display text-sm text-[var(--text-soft)]">
