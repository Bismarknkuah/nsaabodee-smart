      ...
      <main className="grid gap-6 px-8 py-8 md:grid-cols-2">
        ...
        {member.is_town_leader && (
          <div className="rounded-sm border-2 border-[var(--gold)] bg-white p-4">
            ...
            <p className="mt-1 text-xs text-[var(--ink-soft)]">Pays the Town Elders' own rate, on the separate Town Elders ledger.</p>
          </div>
        )}
  ...
  return (
    <section className="rounded-sm border border-[var(--rule)] bg-white p-4">
      ...
      <div className="mt-3 flex items-end gap-2">
        <select value={title} onChange={(e) => setTitle(e.target.value as typeof title)} className="rounded-sm border border-[var(--rule)] px-3 py-2 text-sm">
