  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <main className="grid gap-6 px-8 py-8 md:grid-cols-2">
        ...
        <section className="rounded-sm border border-[var(--border)] bg-white p-6 md:col-span-2">
            ...
            <div className="mt-2">
              ...
              <div className="mt-2 flex gap-2">
                <input
                  ...
                  className="w-64 rounded-sm border border-[var(--border)] px-3 py-2 text-sm"
                />
                <button
              ...
              {!member.linked_username && (
                <>
                  <input
                    ...
                    className="w-48 rounded-sm border border-[var(--border)] px-3 py-2 text-sm"
                  />
                  <input
                    type="password"
        ...
        {member.is_town_leader && (
          <div className="rounded-sm border-2 border-[var(--gold)] bg-white p-4">
        ...
        <section className="flex flex-col items-center rounded-sm border border-[var(--border)] bg-white p-6">
          <h2 className="font-display text-lg">Digital membership card</h2>
          {card && (
            <div className="mt-4 w-full max-w-xs rounded-sm border border-[var(--border)] bg-[var(--surface)] p-5 text-center">
              {card.photo_url ? (
  ...
  return (
    <section className="rounded-sm border border-[var(--border)] bg-white p-4">
      ...
      <div className="mt-3 flex items-end gap-2">
        <select value={title} onChange={(e) => setTitle(e.target.value as typeof title)} className="rounded-sm border border-[var(--border)] px-3 py-2 text-sm">
        ...
        <button
          ...
          className="rounded-sm bg-[var(--gold)] px-4 py-2 text-sm font-medium text-white"
        >
          Transfer
        </button>
      </div>
