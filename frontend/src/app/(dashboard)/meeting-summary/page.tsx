      ...
      <main className="grid gap-6 px-8 py-8 lg:grid-cols-2">
        <form onSubmit={submit} className="space-y-3">
          ...
          <textarea
            ...
            className="w-full rounded-sm border border-[var(--border)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
          />
          <button
            type="submit"
        ...
        <div>
          {data ? (
            ...
            <div className="flex h-full items-center justify-center rounded-sm border border-dashed border-[var(--border)] p-10 text-center text-sm text-[var(--text-soft)]">
