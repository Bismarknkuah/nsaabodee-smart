      ...
      <main className="grid gap-6 px-8 py-8 lg:grid-cols-2">
        <form onSubmit={submit} className="space-y-3">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-[var(--border)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
          />
          <button
            type="submit"
          ...
          {error && (
            <p className="rounded-lg bg-[var(--clay-red-soft)] p-3 text-sm text-[var(--clay-red)]">
              {error.message}
            </p>
          )}
        </form>
        ...
        <div>
          {data ? (
            <div className="space-y-4">
              ...
              <section className="rounded-lg border border-[var(--border)] bg-white p-4">
                ...
                {data.decisions.length === 0 ? (
                  <p className="mt-2 text-sm text-[var(--text-soft)]">None identified.</p>
                ) : (
            ...
            <div className="flex h-full items-center justify-center rounded-lg border border-dashed border-[var(--border)] p-10 text-center text-sm text-[var(--text-soft)]">
