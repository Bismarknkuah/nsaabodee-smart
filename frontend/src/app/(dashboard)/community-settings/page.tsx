              ...
              <div className="flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  {primaryColor && /^#[0-9A-Fa-f]{6}$/.test(primaryColor) && (
                    <span className="h-8 w-8 shrink-0 rounded-lg border border-[var(--border)]" style={{ backgroundColor: primaryColor }} />
                  )}
                </div>
              </div>
              <div className="flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  {secondaryColor && /^#[0-9A-Fa-f]{6}$/.test(secondaryColor) && (
                    <span className="h-8 w-8 shrink-0 rounded-lg border border-[var(--border)]" style={{ backgroundColor: secondaryColor }} />
                  )}
                </div>
              </div>
            </div>
      ...
      <div className="mt-4 grid gap-6 sm:grid-cols-2">
        <div>
          ...
          <button
            ...
            className="mt-2 rounded-lg bg-[var(--forest)] px-4 py-2 text-sm font-medium text-white disabled:opacity-60"
          >
        ...
        <div>
          ...
          <div className="mt-2 flex gap-2">
            <input
              ...
              className="flex-1 rounded-lg border border-[var(--border)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
            />
            <button
