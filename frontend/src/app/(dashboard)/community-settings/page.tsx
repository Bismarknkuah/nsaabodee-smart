  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <header className="border-b-2 border-[var(--ink)] px-8 py-6">
        <p className="font-mono text-[11px] font-medium uppercase tracking-[0.2em] text-[var(--text-soft)]">Your Workspace</p>
      ...
      <main className="grid max-w-4xl gap-6 px-8 py-8 sm:grid-cols-2">
        ...
        <section className="rounded-sm border border-[var(--border)] bg-white p-5">
          ...
          <p className="mt-1 text-sm text-[var(--text-soft)]">Your community&apos;s tagline and color scheme.</p>
          ...
          <div className="mt-4 space-y-3">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full rounded-sm border border-[var(--border)] px-3 py-2 text-sm"
              />
            </div>
              ...
              <div className="flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  {primaryColor && /^#[0-9A-Fa-f]{6}$/.test(primaryColor) && (
                    <span className="h-8 w-8 shrink-0 rounded-sm border border-[var(--border)]" style={{ backgroundColor: primaryColor }} />
                  )}
                </div>
              </div>
              <div className="flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  {secondaryColor && /^#[0-9A-Fa-f]{6}$/.test(secondaryColor) && (
                    <span className="h-8 w-8 shrink-0 rounded-sm border border-[var(--border)]" style={{ backgroundColor: secondaryColor }} />
                  )}
                </div>
              </div>
            </div>
          ...
          <div className="mt-4 space-y-3">
            <div>
              ...
              <input
                ...
                className="mt-1 w-32 rounded-sm border border-[var(--border)] px-3 py-2 text-sm"
              />
            </div>
        ...
        <div>
          ...
          <div className="mt-2 flex gap-2">
            <input
              ...
              className="flex-1 rounded-sm border border-[var(--border)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
            />
            <button
              onClick={() => restore.mutate()}
              disabled={restore.isPending || !driveLink.trim()}
              className="rounded-sm border border-[var(--border)] px-4 py-2 text-sm font-medium disabled:opacity-60"
            >
