    ...
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <main className="mx-auto max-w-3xl px-8 py-8">
        ...
        <ul className="mt-4 space-y-4">
          {board?.map((a) => (
            <li key={a.id} className="rounded-lg border border-[var(--border)] bg-white p-6">
              ...
              {a.image_url && (
                ...
                <img src={a.image_url} alt="" className="mt-3 max-h-80 w-full rounded-lg object-cover" />
              )}
              {a.video_url && (
    ...
    <section className="rounded-lg border border-[var(--border)] bg-white p-6">
        ...
        <div>
          ...
          <div className="mt-1 flex flex-wrap gap-2">
            ...
            <input
              ...
              className="flex-1 rounded-lg border border-[var(--border)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)] disabled:bg-[var(--bg)] disabled:text-[var(--text-soft)]"
            />
          </div>
        </div>
      ...
      {rejected.length > 0 && (
        <div className="mt-6 border-t border-[var(--border)] pt-4">
          ...
          {rejected.map((a) => (
            <div key={a.id} className="mt-2 rounded-lg bg-[var(--clay-red-soft,#f6e6e3)] p-3">
              ...
              <button
                ...
                className="mt-1.5 rounded-lg bg-[var(--forest)] px-3 py-1.5 text-xs font-medium text-white"
              >
                Edit &amp; resend
              </button>
            </div>
