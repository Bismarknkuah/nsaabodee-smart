        ...
        <div>
          ...
          <div className="mt-1 flex flex-wrap gap-2">
            ...
            <input
              ...
              className="flex-1 rounded-sm border border-[var(--rule)] px-3 py-2 text-sm outline-none focus:border-[var(--forest)] disabled:bg-[var(--surface)] disabled:text-[var(--ink-soft)]"
            />
          </div>
        </div>
