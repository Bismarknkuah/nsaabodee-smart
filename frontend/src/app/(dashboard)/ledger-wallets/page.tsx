        ...
        <div className="border-t border-[var(--border)] px-5 py-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <input
              ...
              placeholder="Amount"
              className="w-32 rounded-sm border border-[var(--border)] px-3 py-1.5 text-sm"
            />
            <input
              value={note}
              onChange={(e) => setNote(e.target.value)}
              placeholder="What this withdrawal is for…"
              className="min-w-[16rem] flex-1 rounded-sm border border-[var(--border)] px-3 py-1.5 text-sm"
            />
            <button
          ...
          <ul className="max-h-72 divide-y divide-[var(--rule)] overflow-y-auto border-y border-[var(--border)]">
            {transactions?.map((t) => (
