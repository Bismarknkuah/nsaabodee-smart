  ...
  return (
    <div className="font-body min-h-screen bg-[var(--bg)] text-[var(--text)]">
      <header className="border-b border-[var(--border)] bg-[var(--card)] px-8 py-6">
        <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-[var(--text-soft)]">Front Desk</p>
        ...
        <div className="mt-4">
          {queuedOperations.length === 0 ? (
            <div className="border border-dashed border-[var(--border)] px-6 py-10 text-center">
              ...
              <p className="mt-1 text-sm text-[var(--text-soft)]">Everything this device has recorded has reached the server.</p>
            </div>
          ) : (
