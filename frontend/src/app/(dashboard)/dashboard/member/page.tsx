                ...
                {overview.my_tasks.map((t) => (
                  <li key={t.id} className="flex items-center justify-between gap-3 py-2 text-sm">
                    ...
                    <div className="text-right">
                      <span className="rounded-sm bg-[var(--surface)] px-2 py-0.5 text-xs capitalize text-[var(--text-soft)]">
              ...
              <ul className="space-y-1.5 text-sm">
                {overview.my_desk_assignments.map((a) => (
                  <li key={a.funeral_event_id}>
                    ...
                    <span className="text-[var(--text-soft)]">for {a.funeral_event__deceased_name}&apos;s funeral</span>
                  </li>
                ))}
              </ul>
            </SectionCard>
