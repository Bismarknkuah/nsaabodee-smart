        ...
        <>
          ...
          <main className="mx-auto max-w-2xl px-6 py-14 sm:px-10">
            ...
            {data.payout_accounts.length > 0 && (
              <section className="mt-10 rounded-lg border border-[var(--nb-gold)] bg-[var(--nb-gold-soft)] p-6">
              ...
              {data.tributes.length === 0 ? (
                ...
                <ul className="mt-5 space-y-4">
                  {data.tributes.map((t, i) => (
                    <li key={i} className="rounded-lg border border-black/10 bg-white p-5">
              ...
              {submitted ? (
                ...
                <form onSubmit={submitTribute} className="mt-3 space-y-3">
                  <input
                    ...
                    className="w-full rounded-lg border border-black/10 px-3 py-2 text-sm outline-none focus:border-[var(--nb-navy)]"
                  />
                  <textarea
                    value={message}
                  ...
                  <button
                    ...
                    className="rounded-lg bg-[var(--nb-navy)] px-5 py-2 text-sm font-medium text-white disabled:opacity-60"
                  >
