    ...
    <div className="font-body flex min-h-screen">
      ...
      <div className="grid w-full max-w-4xl gap-8 lg:grid-cols-2">
        <div className="border border-[var(--border)] bg-white p-8">
          <Link href="/" className="inline-flex items-center gap-1 font-mono text-xs uppercase tracking-widest text-[var(--text-soft)] hover:text-[var(--forest)]">
            ← Back to homepage
          </Link>
          ...
          <div className="mt-5 flex gap-1 border border-[var(--border)] bg-[var(--surface)] p-1 text-xs font-medium">
            <button
              type="button"
          ...
          <form onSubmit={submit} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 w-full border-0 border-b-2 border-[var(--border)] bg-transparent px-0 py-2 text-sm outline-none focus:border-[var(--forest)]"
              />
            </div>
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="w-full border-0 border-b-2 border-[var(--border)] bg-transparent px-0 py-2 pr-14 text-sm outline-none focus:border-[var(--forest)]"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((v) => !v)}
                  className="absolute inset-y-0 right-0 text-xs font-medium text-[var(--text-soft)] hover:text-[var(--forest)]"
                  tabIndex={-1}
                >
          ...
          <form onSubmit={otpSent ? verifyCode : sendCode} className="mt-6 space-y-4">
            <div>
              ...
              <input
                ...
                disabled={otpSent}
                autoFocus
                className="mt-1 w-full border-0 border-b-2 border-[var(--border)] bg-transparent px-0 py-2 text-sm outline-none focus:border-[var(--forest)] disabled:text-[var(--text-soft)]"
              />
            </div>
            ...
            {otpSent && (
              <div>
                ...
                />
                {otpDemoCode && (
                  <p className="mt-2 rounded-sm border border-dashed border-[var(--gold)] bg-[var(--gold)]/10 px-3 py-2 text-xs text-[var(--text)]">
                ...
                <button
                  ...
                  className="mt-1 text-xs text-[var(--text-soft)] hover:text-[var(--forest)]"
                >
          ...
          {mode === "forgot" && (
            <div className="mt-6">
                ...
                {resetSent && (
                  <>
                    ...
                    <button
                      ...
                      className="text-xs text-[var(--text-soft)] hover:text-[var(--forest)]"
                    >
                      Use a different number
                    </button>
                  </>
              ...
              <button
                ...
                className="mt-4 text-xs text-[var(--text-soft)] hover:text-[var(--forest)]"
              >
                ← Back to sign in
              </button>
            </div>
