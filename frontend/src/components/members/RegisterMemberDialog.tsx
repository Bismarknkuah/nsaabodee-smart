      ...
      <div className="font-body w-full max-w-lg rounded-sm bg-[var(--surface)] p-6 text-[var(--ink)] shadow-xl">
        ...
        {duplicates && duplicates.length > 0 ? (
          ...
          <form onSubmit={submit} className="mt-4 space-y-4">
            ...
            >
              {showMoreDetails ? "Hide additional details" : "+ Add date of birth, email, address, occupation, emergency contact (optional)"}
            </button>
            {showMoreDetails && (
              <div className="space-y-3 rounded-sm bg-[var(--surface)] p-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="mt-1 w-full rounded-sm border border-[var(--rule)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
                    />
                    <p className="mt-1 text-xs text-[var(--ink-soft)]">Lets us wish them well on their birthday</p>
                  </div>
                  <div>
