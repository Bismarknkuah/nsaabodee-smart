...
export function InLawContributionsPanel({ funeralId }: { funeralId: string }) {
  ...
  return (
    <div className="rounded-lg bg-[var(--bg)] p-4">
      <div className="flex items-center justify-between">
        ...
        {canRequest && !showRequestForm && (
          <button
            ...
            className="rounded-lg bg-[var(--forest)] px-3 py-1.5 text-sm font-medium text-white"
          >
      ...
      {showRequestForm && (
        <form onSubmit={submitRequest} className="mt-4 space-y-3 rounded-lg bg-white p-3">
          <div>
            ...
            {r.status === "pending" && canDecide && (
              <div className="mt-2 flex gap-2">
                ...
                <button
                  ...
                  disabled={decideMutation.isPending}
                  className="rounded-lg border border-[var(--rule)] px-3 py-1.5 text-xs font-medium disabled:opacity-60"
                >
                  Reject
                </button>
              </div>
            ...
            {r.obligation && r.obligation.payment_status !== "paid" && (
              <div className="mt-2">
                {payingObligationId === r.obligation.id ? (
                  <form onSubmit={submitPayment} className="mt-2 space-y-2 rounded-lg bg-[var(--bg)] p-2">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-[var(--rule)] px-2 py-1.5 text-sm outline-none focus:border-[var(--forest)]"
                    />
                  ...
                  <button
                    ...
                    className="mt-1 rounded-lg border border-[var(--rule)] px-3 py-1.5 text-xs font-medium"
                  >
