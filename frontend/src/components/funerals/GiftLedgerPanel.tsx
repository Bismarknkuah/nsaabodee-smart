...
export function GiftLedgerPanel({ funeralId }: { funeralId: string }) {
  ...
  return (
    <section className="mt-10 rounded-lg border-2 border-[var(--violet)] bg-white p-5">
      ...
      <div className="mt-2 flex justify-end">
        <button
          onClick={() => router.push(`/pay-gift-momo/${funeralId}`)}
          className="rounded-lg border px-3 py-1.5 text-xs font-medium hover:opacity-80"
      ...
      {isAnonymized && (
        <div className="mt-3 flex items-center justify-between gap-3 rounded-lg border border-dashed p-3 text-xs" style={{ borderColor: "var(--gold)", backgroundColor: "var(--gold-soft, transparent)" }}>
          {reconciliationReason ? (
            ...
            <>
              ...
              <button
                ...
                className="shrink-0 rounded-lg border px-3 py-1 font-medium hover:opacity-80"
                style={{ borderColor: "var(--violet)", color: "var(--violet)" }}
              >
      ...
      {isError ? (
        <div className="mt-4 rounded-lg border border-dashed border-[var(--rule)] p-4 text-sm text-[var(--ink-soft)]">
        ...
        <>
          {categoryBreakdown && (
            <div className="mt-4 grid grid-cols-3 gap-3 rounded-lg p-3 text-center text-sm" style={{ backgroundColor: "var(--violet-soft)" }}>
          ...
          <div className="mt-4 flex gap-1 rounded-full bg-[var(--bg)] p-1 text-xs">
