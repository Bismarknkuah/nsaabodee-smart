    ...
    <div className="mt-3 rounded-lg bg-[var(--bg)] p-3">
      ...
      <div className="mt-3 space-y-2">
        ...
        {!showDraftHelper ? (
          ...
          <div className="rounded-lg border border-dashed border-[var(--violet)] bg-white p-2">
            ...
            <textarea
              ...
              rows={2}
              className="mt-1 w-full rounded-lg border border-[var(--rule)] px-2 py-1.5 text-xs outline-none focus:border-[var(--violet)]"
            />
            <div className="mt-1.5 flex items-center gap-2">
              <button
                ...
                className="rounded-lg bg-[var(--violet)] px-2.5 py-1 text-xs font-medium text-white disabled:opacity-50"
              >
      ...
      {pending.length > 0 && (
        <div className="mt-4 border-t border-[var(--rule)] pt-3">
          ...
          <ul className="mt-2 space-y-2">
            {pending.map((t) => (
              <li key={t.id} className="rounded-lg bg-white p-2 text-xs">
                <p>{t.message}</p>
