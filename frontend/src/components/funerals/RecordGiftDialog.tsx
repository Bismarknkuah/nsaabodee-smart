    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="font-body w-full max-w-md rounded-sm bg-[var(--surface)] p-6 text-[var(--ink)] shadow-xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={submit} className="mt-4 space-y-4">
          ...
          <details className="rounded-sm bg-white p-3 text-sm">
            ...
            <div className="mt-3 grid grid-cols-2 gap-3">
              ...
              <div className="col-span-2">
                <label className="text-sm font-medium">Giving on behalf of a group?</label>
                <input
                ...
                />
                <p className="mt-1 text-xs text-[var(--ink-soft)]">
                  Leave blank for an ordinary individual gift. Fill in when one representative — e.g.
                  a town or family delegation — is giving on behalf of a group.
                </p>
              </div>
            </div>
          </details>
          ...
          <div>
            <label className="text-xs font-medium uppercase tracking-wide text-[var(--ink-soft)]">Your name</label>
            <input
              value={collectorName}
