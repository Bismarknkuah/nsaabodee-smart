    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
        <div className="font-body w-full max-w-sm rounded-lg bg-[var(--bg)] p-6 text-center text-[var(--ink)] shadow-xl">
          ...
          <button onClick={onClose} className="mt-4 rounded-lg bg-[var(--forest)] px-4 py-2 text-sm font-medium text-white">
            Done
          </button>
        </div>
      </div>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
        <div className="font-body w-full max-w-sm rounded-lg bg-[var(--bg)] p-6 text-center text-[var(--ink)] shadow-xl">
          ...
          <div className="mt-4 flex justify-center gap-2">
            <button onClick={onClose} className="rounded-lg border border-[var(--rule)] px-4 py-2 text-sm">Done</button>
            <button onClick={printReceipt} className="rounded-lg px-4 py-2 text-sm font-medium text-white" style={{ backgroundColor: "var(--violet)" }}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="font-body flex max-h-[85vh] w-full max-w-md flex-col overflow-hidden rounded-lg bg-[var(--bg)] text-[var(--ink)] shadow-xl">
        ...
        {!online && (
          <p className="mt-2 rounded-lg bg-[var(--bg)] px-3 py-2 text-xs text-[var(--gold)]">
