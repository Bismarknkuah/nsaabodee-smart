    ...
    <section className="mt-6 rounded-sm border border-[var(--rule)] bg-white p-5">
      <div className="flex items-start justify-between gap-4">
        ...
        {canRecord && (
          <div className="flex shrink-0 gap-2">
            <button onClick={() => setShowFundForm((s) => !s)} className="rounded-sm border border-[var(--rule)] px-4 py-2 text-sm font-medium hover:border-[var(--ink)]">
              {showFundForm ? "Cancel" : "Add fund"}
            </button>
            <button onClick={() => setShowForm((s) => !s)} className="rounded-sm border border-[var(--rule)] px-4 py-2 text-sm font-medium hover:border-[var(--ink)]">
      ...
      {showFundForm && canRecord && (
        <form
          ...
          className="mt-3 space-y-2 rounded-sm bg-[var(--surface)] p-3"
        >
