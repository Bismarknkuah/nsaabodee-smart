    ...
    <div className="rounded-lg bg-[var(--bg)] p-4">
      ...
      <div className="mt-3">
        <input
          ...
          className="w-full rounded-lg border border-[var(--rule)] bg-white px-3 py-2 text-sm outline-none focus:border-[var(--forest)]"
        />
              ...
              return (
                <li key={m.id} className="flex items-center justify-between px-3 py-2 text-sm">
                  ...
                  <button
                    ...
                    className="rounded-lg border border-[var(--rule)] px-2 py-1 text-xs font-medium disabled:opacity-50 hover:border-[var(--forest)] hover:text-[var(--forest)]"
                  >
