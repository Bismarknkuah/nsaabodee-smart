...
export function DeleteFamilyDialog() {
  ...
  return (
    ...
    >
      {hasMembers && (
        <div className="mb-4 rounded-lg bg-[var(--clay-red-soft)] p-3 text-sm text-[var(--clay-red)]">
      ...
      <div className="flex justify-end gap-2">
        ...
        <button
          ...
          className="rounded-lg bg-[var(--clay-red)] px-4 py-2 text-sm font-medium text-white disabled:opacity-60"
        >
