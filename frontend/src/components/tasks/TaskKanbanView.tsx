      ...
      {COLUMNS.map((col) => {
        ...
        return (
          <div
            ...
            className="min-h-[16rem] rounded-lg border border-[var(--rule)] bg-[var(--bg)] p-3"
            ...
            <div className="mt-2 space-y-2">
              {columnTasks.map((t) => (
                <div
                  ...
                  className="cursor-grab rounded-lg border border-[var(--rule)] bg-white p-2 text-sm active:cursor-grabbing"
