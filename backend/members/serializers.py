...
class MemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "phone", "email", "address", "ghana_card_number", "photo_url", "family", "family_detail",
...
class MemberUpdateSerializer(serializers.Serializer):
    ...
    marital_status = serializers.ChoiceField(choices=Member.MaritalStatus.choices, required=False, allow_blank=True)
...
class MemberRegisterSerializer(serializers.Serializer):
    ...
    marital_status = serializers.ChoiceField(choices=Member.MaritalStatus.choices, required=False, allow_blank=True, default="")
...
class AssignRoleSerializer(serializers.Serializer):
    ...
    # A plain CharField, not a ChoiceField restricted to any single
    # role list: assign_role_to_member itself validates the role
    # against whichever of ASSIGNABLE_COMMUNITY_ROLES,
    # FAMILY_HEAD_ASSIGNABLE_ROLES, or TRADITIONAL_LEADER_ASSIGNABLE_ROLES
    # actually applies to the acting user, since a Community Admin,
    # a Family Head, and a Traditional Leader each have a genuinely
    # different, narrower set they're allowed to assign.
