...
class FamilyHeadScopedRegistrationTests(TestCase):
    ...
    def test_family_head_can_no_longer_register_even_into_their_own_family(self):
        """'The family secretary will be responsible for all adding members' — corrected from this test's own original name and assertion."""
