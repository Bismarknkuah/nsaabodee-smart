...
def assign_role_to_member(*, member: Member, role: str, actor, username: str = None, password: str = None):
    ...
    if actor.role == "community_admin":
        ...
        if role not in FAMILY_HEAD_ASSIGNABLE_ROLES:
            raise ValidationError(f"'{role}' isn't a role a Family Head can assign.")
        ...
        raise ValidationError("Only the Community Admin, a Family Head, or the Traditional Leader can assign roles.")
