...
TASK_ASSIGNMENT_ROLES = {
    ...
    # 'The family secretary should have options to assign tasks to family members only.'
    Role.FAMILY_SECRETARY,
    # 'The Traditional Leader should be able to assign tasks to the
    # community executives and the family head, since he is the leader.'
    Role.TRADITIONAL_LEADER,
}

COMMUNITY_WIDE_TASK_ROLES = {
    Role.COMMUNITY_ADMIN, Role.CHAIRMAN, Role.SECRETARY,
    # Matches the same addition to TASK_ASSIGNMENT_ROLES below — without
    # this, the Traditional Leader would pass the initial permission
    # check but then fail every single assignment on the family-scope
    # check, since they typically have no family of their own at all.
    Role.TRADITIONAL_LEADER,
}
