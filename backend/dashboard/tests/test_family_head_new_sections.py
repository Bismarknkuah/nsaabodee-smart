...
class FamilyHeadComplianceBreakdownTests(TestCase):
    ...
    def setUp(self):
        ...
        funeral_services.record_payment(obligation=paid_obligation, amount=paid_obligation.expected_amount, method="cash", collector=self.admin, collector_name="Test Collector")
