...
urlpatterns = [
    ...
    path("reports/town-elders-ledger/", views.TownEldersLedgerReportView.as_view(), name="report-town-elders-ledger"),
    path("reports/members/export/", views.MembersExportView.as_view(), name="members-export"),
    ...
    path("receipts/contribution-payments/<uuid:payment_id>/qr-code/", views.ContributionReceiptQrCodeView.as_view(), name="receipt-contribution-qr-code"),
    ...
    path("receipts/contribution-payments/<uuid:payment_id>/send-tracking-sms/", views.SendPaymentTrackingSmsView.as_view(), name="receipt-contribution-send-tracking-sms"),
    path("receipts/contribution-payments/<uuid:payment_id>/verify/", views.ReceiptVerificationView.as_view(), name="receipt-contribution-verify"),
    path("receipts/contribution-payments/<uuid:payment_id>/qr-code/", views.ReceiptQrCodeView.as_view(), name="receipt-contribution-qr-code"),
