...
def record_funeral_expense(*, family, funeral_event, item_name, seller_name, amount, date_purchased,
                            seller_contact="", paid_by_member=None, recorded_by=None, funding_source=""):
    """
    ...
    funeral is coming from.' funding_source is optional here (matching
    the model field's own safe default) rather than required — the
    real accountability need is that it CAN be recorded, and every
    real, user-facing form always will pass one.
    """
