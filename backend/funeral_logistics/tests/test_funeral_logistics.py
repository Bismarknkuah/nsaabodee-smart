...
class FinancialOverviewTests(TestCase):
    ...
    def test_overview_combines_all_three_pictures_without_merging_them(self):
        ...
        gift_services.record_gift_donation(funeral=self.funeral, donor_name="A Donor", amount_cash=Decimal("200"), collector_name="Test Collector")
        ...
        # donation collected." Contributions minus expenses only —
        # gift_cash_collected above is its own, separate figure, never
        # netted against expenses.
        self.assertEqual(Decimal(overview["net_cash_position"]), Decimal("-50"))  # 50 - 100, gifts not included
