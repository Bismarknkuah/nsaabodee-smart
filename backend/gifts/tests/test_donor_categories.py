...
class DonorCategoryTests(TestCase):
    ...
    def test_donations_by_category_breaks_down_correctly(self):
        gift_services.record_gift_donation(funeral=self.funeral, donor_name="Guest A", amount_cash=Decimal("20"), collector_name="Test Collector")
        gift_services.record_gift_donation(funeral=self.funeral, donor_name="Guest B", amount_cash=Decimal("30"), collector_name="Test Collector")
