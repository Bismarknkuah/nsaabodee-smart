...
class GiftDonationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "relationship_to_recipient", "delegation_size",
...
class RecordGiftDonationSerializer(serializers.Serializer):
    ...
    # 'One representative may present a contribution on behalf of Town
    # A... without necessarily creating 15 separate financial
    # obligations.' Optional — omitted or null means an ordinary,
    # individual gift.
    delegation_size = serializers.IntegerField(required=False, allow_null=True, min_value=1, default=None)
    ...
    def save(self, **kwargs):
        ...
        try:
            return services.record_gift_donation(
                ...
                delegation_size=data.get("delegation_size"),
